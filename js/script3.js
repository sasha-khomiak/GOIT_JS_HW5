// Тестувальники знайшли баги в коді сервісу зберігання історії
// замовлень їжі.Тобі необхідно виправити їх, правильно розставивши
// this в методах об'єкта historyService, щоб
// методи почали працювати правильно.
